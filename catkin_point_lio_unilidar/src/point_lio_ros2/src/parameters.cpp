...
std::vector<double> body_to_baselink_T;
std::vector<double> body_to_baselink_R;
bool publish_in_baselink_frame = false;
...
void readParameters(shared_ptr<rclcpp::Node> &nh) {
    ...
    nh->declare_parameter<std::vector<double>>("mapping.body_to_baselink_T", {0, 0, 0});
    nh->declare_parameter<std::vector<double>>("mapping.body_to_baselink_R", {1, 0, 0, 0, 1, 0, 0, 0, 1});
    nh->declare_parameter<bool>("mapping.publish_in_baselink_frame", false);
    ...
    nh->get_parameter("mapping.body_to_baselink_T", body_to_baselink_T);
    nh->get_parameter("mapping.body_to_baselink_R", body_to_baselink_R);
    nh->get_parameter("mapping.publish_in_baselink_frame", publish_in_baselink_frame);
